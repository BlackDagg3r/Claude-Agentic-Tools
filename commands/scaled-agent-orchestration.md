...
**Mode detection:**
- If $ARGUMENTS mentions "build", "create", "implement", "develop", "scaffold", "make", "generate", "new app", "new project", "greenfield", or "add feature": use the **build pipeline** — run `/build-pipeline $ARGUMENTS` instead.
